...
已注册因子（按导入顺序）：
    ...
    individual       → IndividualFeature（个股精细因子集：振幅/位置/波动结构/量价/行为，89列）
...
from features.individual.individual_feature import IndividualFeature        # noqa: F401  # 个股精细因子集：振幅/位置/波动结构/量价/行为（89列，个股因子）
